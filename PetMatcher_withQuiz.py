...
def homepage():
    ...
    Button(home, text = "View Essential Items for your Pet", font = ("Courier", 12), width = 40, height = 2, command = browsemain).grid(row = 2, column =0, padx = 50, pady = 12)
