...
def dogtasks():
    ...
    while :
        if GPIO.input(button_red) == 1:
            GPIO.output(red, True)
            dogfeed += 1
        else:
            pass
        
        if GPIO.input(button_yellow) == 1:
            GPIO.output(yellow, True)
            dogbath += 1
        else:
            pass
        
        if GPIO.input(button_blue) == 1:
            GPIO.output(blue, True)
            dogplay += 1
        else:
            pass
        
        if GPIO.input(button_green) == 1:
        ...
        if dogfeed > 2:
            messagebox.showinfo("Day's Feeding Complete", "You've completed all feeding tasks today.")
        else:
            pass
        
        if dogbath > 1:
            messagebox.showinfo("Day's Bath Complete", "You've completed all bathing tasks today.")
        else:
            pass
        
        if dogplay> 1:
            messagebox.showinfo("Day's Play Time Complete", "You've completed all playing tasks today.")
        else:
            pass
        
        if dogwalk > 2:
            messagebox.showinfo("Day's Walking Complete", "You've completed all walking tasks today.")
        else:
            pass
...
PATH = r"/home/pi/CSC101/PetMatcher" #
os.chdir(PATH)
